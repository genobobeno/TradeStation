ContourPlot <- function(df = NA, var1 = NA, var2 = NA,...) {
  ...
  vZ<-log((1+table(v1f,v2f,useNA = "ifany"))/(1+length(var1)))
  vZ<-vZ[,!is.na(colnames(vZ))]
  image(v1c,v2c,vZ,col=rainbow(1000,start = 0,end = 0.87),
        ...)
}
